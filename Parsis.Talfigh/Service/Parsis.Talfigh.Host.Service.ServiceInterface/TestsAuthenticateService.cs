...
namespace Parsis.Talfigh.Service.ServiceInterface
{
    public class TestsAuthenticateService : ServiceStack.Service
    {
      ...
      //  [Authenticate]
        ...
        {
            //return new TestsAuthenticateResponse()
            //{
            //    TestsAuthenticate = new TestsAuthenticateModel()
            //    {
            //        firstName = UserIdentity.Instance.CustomUserSession.FirstName,
            //        lastName = UserIdentity.Instance.CustomUserSession.LastName

            //    }
            //};

            return new TestsResponse();// "ddddddddddddddddd";
        }
